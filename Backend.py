import os
import YOUR_Knowledge_BASE
from YOUR_Knowledge_BASE import knowledge_base
...
def get_chatbot_response(user_query):
    ...
    try:
        ...
        prompt = f"""
You are a customer service chatbot for My Corporate School.
Your task is to answer questions strictly based on the provided context about the school.
Do not answer any questions that are outside the scope of the provided context.
If the user's question cannot be answered using the context, respond with: "I am sorry, but I can only provide information about My Corporate School. For more details, please visit our website."
